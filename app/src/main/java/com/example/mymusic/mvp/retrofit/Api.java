...
public class Api {
    //根据歌手获取歌手图片
    public static final String SINGER_PIC_BASE_URL = "http://music.163.com/";//歌手图片的baseUrl
    public static final String SINGER_PIC = "api/search/get/web?csrf_token=&type=100";//歌手图片url
